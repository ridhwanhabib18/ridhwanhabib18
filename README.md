...
- Built systems using **C#**, **ASP.NET Core**, **React**, **Vue**, **jQuery**, **TypeScript**, **JavaScript**, and **AWS**, with strong expertise in database management and processing using **MySQL** and **SQL Server**.  
...
|----------|--------------|--------|---------------|
| [**Wedding Invitation Project for Abyuleman**](https://github.com/ridhwanhabib18/Fullstack-Web-System) | Automated internal approval system for enterprise workflow. | PHP, Laravel, HTML, CSS, MySQL, MariaDB, Linux, HestiaCP, Bash, YAML | This Documentation is Confidential |
| [**Workflow Invoice Paperless and Payment System - Epson Internal Automation for Invoice and Debit Note Verification and Payment Process System**](https://github.com/ridhwanhabib18/Fullstack-Web-System) | Automated internal approval system for enterprise workflow. | .NET 8, React, TS, SQL Server, Kendo, Github, CI/CD, YAML | This Documentation is Confidential |
| [**MATRIX - Epson Internal Automation of Scheduling, Calculation Process, and Part Production Planning for Part Production Department**](https://github.com/ridhwanhabib18/Fullstack-Web-System) | Automated internal approval system for enterprise workflow. | .NET 10, React, TS, SQL Server, Kendo, Github, CI/CD, YAML, Kendo | This Documentation is Confidential |
...
| [**Coffee Roaster Control System with Motorized Ball Valve and GUI for Monitor Roasting Process**](https://github.com/ridhwanhabib18/IoT-Temperature-Control) | PID-controlled gas roaster system using Arduino and sensors. | Arduino, C++, C#, WPF, .NET Framework 4.8 | |
